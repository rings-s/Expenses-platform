...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-wm)in0u^n4pg!cfk)yg6+*7(h+cv3!6%l4yetg60rgbrctnbys')
...
MIDDLEWARE = [
    ...
    'accounts.middleware.JWTAuthenticationMiddleware',  # Add this after AuthenticationMiddleware
